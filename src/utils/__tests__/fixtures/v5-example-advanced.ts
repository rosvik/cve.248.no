export const v5ExampleAdvanced = {
  dataType: "CVE_RECORD",
  dataVersion: "5.0",
  cveMetadata: {
    cveId: "CVE-1337-1234",
  ...
  containers: {
    cna: {
      ...
      title:
        "Buffer overflow in Example Enterprise allows Privilege Escalation.",
      ...
      descriptions: [
        {
          lang: "en",
          value:
            "OS Command Injection vulnerability parseFilename function of example.php in the Web Management Interface of Example.org Example Enterprise on Windows, macOS, and XT-4500 allows remote unauthenticated attackers to escalate privileges. This issue affects: 1.0 versions before 1.0.6, 2.1 versions from 2.16 until 2.1.9.",
          supportingMedia: [
            {
              type: "text/html",
              base64: false,
              value:
                "OS Command Injection vulnerability <tt>parseFilename</tt> function of <tt>example.php</tt> in the Web Management Interface of Example.org Example Enterprise on Windows, macOS, and XT-4500 allows remote unauthenticated attackers to escalate privileges.<br><br>This issue affects:<br><ul><li>1.0 versions before 1.0.6</li><li>2.1 versions from 2.16 until 2.1.9.</li></ul>",
            },
          ],
        },
        {
          ...
          supportingMedia: [
            {
              ...
              base64: false,
              value:
                "OS-komand-injekta vundebleco <tt>parseFilename</tt> funkcio de <tt>example.php</tt> en la Web Administrado-Interfaco de Example.org Example Enterprise ĉe Windows, macOS kaj XT-4500 permesas al malproksimaj neaŭtentikigitaj atakantoj eskaladi privilegiojn.<br><br> Ĉi tiu afero efikas:<br><ul><li>1.0-versioj antaŭ 1.0.6</li><li>2.1-versioj de 2.16 ĝis 2.1.9.</li></ul>",
            },
          ],
        },
      ],
          ...
          scenarios: [
            {
              lang: "en",
              value:
                "If the enhanced host protection mode is turned on, this vulnerability can only be exploited to run os commands as user 'nobody'. Privilege escalation is not possible.",
            },
          ],
          cvssV3_1: {
            version: "3.1",
      ...
      solutions: [
        {
          lang: "en",
          value:
            "This issue is fixed in 1.0.6, 2.1.9, and 3.0.0 and all later versions.",
          supportingMedia: [
            {
              type: "text/html",
              base64: false,
      ...
      workarounds: [
        {
          lang: "en",
          value:
            "Disable the web management interface with the command\n> service disable webmgmt",
          supportingMedia: [
            {
              type: "text/html",
              base64: false,
              value:
                "Disable the web management interface with the command<br><pre>&gt; <b>service disable webmgmt</b></pre>",
            },
          ],
        },
      ],
      configurations: [
        {
          lang: "en",
          value:
            "Web management interface should be enabled.\n> service status webmgmt\nwebmgmt running",
          supportingMedia: [
            {
              type: "text/html",
              base64: false,
              value:
                "Web management interface should be enabled.<br><pre>&gt; <b>service status webmgmt</b><br>webmgmt running</pre>",
            },
          ],
        },
      ],
      exploits: [
        {
          lang: "en",
          value:
            "Example.org is not aware of any malicious exploitation of the issue however exploits targeting this issue are publicly available.",
          supportingMedia: [
            {
              type: "text/html",
              base64: false,
